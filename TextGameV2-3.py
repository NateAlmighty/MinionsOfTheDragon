...
achievements_killer = {
    ...
    'Meta': [
        ...
        'All Stats Increase': 100 },
        {'Name': 'Master Slayer', 'Required': 'All Slayer achievements completed', 'Goal': 6, 'All Stats Increase':
            100 },
        {'Name': 'Master Shopper', 'Required': 'All Shopping achievements completed', 'Goal': 5, 'All Stats Increase':
            100 }
    ]
}
...
achievements_pacifist = {
    ...
    'Romance': [
        ...
        {'Name': 'Happy with Harpies', 'Required': 'Max Romance Score: Harpy', 'Goal': 25, 'Speech4 Increase': 10 },
...
def name_color():
    global name
    return f"\033[1;35m{name}\033[1m"


def job_color():
    global job
    return f"\033[1;35m{job}\033[1m"


def ability_color():
    global ability
    return f"\033[1;35m{ability}\033[1m"
...
def level_color():
    global level
    return f"\033[1;33m{level}\033[1m"


def HP_color():
    global HP
    return f"\033[1;32m{HP}\033[1m"


def speech_color():
    global speech, level
    return f"\033[1;32m{speech * level}\033[1m"


def HPMAX_color():
    global HPMAX, level
    return f"\033[1;32m{HPMAX * level}\033[1m"


def MP_color():
    global MP
    return f"\033[1;34m{MP}\033[1m"


def gifting_color():
    global gifting, level
    return f"\033[1;34m{gifting * level}\033[1m"


def MPMAX_color():
    global MPMAX, level
    return f"\033[1;34m{MPMAX * level}\033[1m"


def TATK_color():
    global TATK, level
    return f"\033[1;31m{TATK * level}\033[1m"


def ATK_color():
    global ATK, level
    return f"\033[1;31m{ATK * level}\033[1m"


def work_color():
    global work, level
    return f"\033[1;31m{work * level}\033[1m"
...
def polly():
    global romance, gifts, gifting, level
    gift_measurement = gifts * gifting * level

    polly_texts = [
        ["As you walk through the town, you hear a familiar squawking noise.",
        "Polly: SQUAAWK - Wanna cracker - BRAAWK!", "You find Polly sitting in a group of pigeons.",
        "Polly: SQUAAWK - If it isn't the adventurer who saved my life - BACKAWW!",
        "Polly: SQUAA - What was your name again?", "Tell Polly your name (y/n)?"]
        [f"Polly: {name_color()}-AWK! Pretty name! Pretty name!"]
        ...
        ["Polly is in her usual pigeon place.", "Polly: BRAWWWK - Thank you, thank you!",
        "Polly happily grabs the feed in her beak and spills the entire package on the ground.",
        "Polly: Oh no, I scared them!", "Polly: I mean - BRAWWK! Time to fly!",
        ...
        "Polly: Oh, it's you... Squawk.", "Polly: I didn't mean to scare the birds.",
        ...
        ["Polly: Me, you, BRAWWK!", "Polly: Of course! Polly - BRAWWK - would love to go out!",
        ...
        "Polly: Brawwk - I mean, hi, " + name_color() + ".", "Polly: I see - brawwk - You have the food - squawk.",
        "You notice she's toning down her Parrot routine this time.", "Tell her she's a cute parrot (y/n)?"]
        ["Polly's face lights up.", "Polly: SQUAAWK - Pretty bird, pretty bird - BRAWWWK!"]
        ["Polly half expects you to say something, but you don't.", "Polly: Pretty bird?", "You catch on, and nod.",
        "Polly's face lights up.", "Polly: SQUAAWK - Pretty bird, pretty bird - BRAWWWK!"]
        ...
        "Polly: Get to my age, you notice a lot - SQUAWWK!", "You start to ask Polly's age, but decide against it.",
        ...
        "Polly: SQUWRRK - wrn minint!", "You can tell she is struggling to talk.",
        ...
        "So when parrot parents abandoned me, the Harpies took me in - BRAWWK!", "Ask Polly for her real story (y/n)?"]
        ...
        ["You come back to where Polly has been waiting for you.", "Polly: SQUAAWK - You got them, you got them!",
        "Polly grabs the canisters of spray paint from you and excitedly starts to spray her feathers as she talks.",
        ...
        "Polly: I'd rather never breed if that's the case.", "Polly: I can date, and hang with males...",
        ...
        "Polly: BRAWWK! Pretty birds, I'm pretty too, SQUAWWK!", "Parrots: Pretty-pretty bird!",
        "Interrupt the dance (y/n)?"]
        ["You yell up for Polly to come down.", "Polly: SQUAWWK - See you later, pretty birds - BRAWWK!",
        ...
        "Polly: Bring Polly many Dragon snacks to feed him - SQUAWWK!", "Bring Polly some gifts from the shop."]
        ["Polly: More snacks for Dragon - SQUAWWK!", "Bring Polly a few more gifts from the shop to continue."]
        ["Polly: You got the Dragon snacks - BRAWWK!", "Polly: Dragon said I had to grow up - SQUAWWK!",
        ...
        ["You find Polly sitting alone, no birds around her.", "Polly: I've been... thinking, " + name_color() + ".",
        ...
        "Polly: I've had to beg and steal to survive, and I don't have a home.","Polly: I need to become... normal."]
        ...
        "Polly: ...And you think she'd be ok with... parrots?", "You tell Polly that Willow is incredibly accepting.",
        "You also mention that since her school will be mostly young kids, she will fit right in with their humor.",
        "Polly smiles wide.", "Polly: BRAWWK - Pretty bird go there at once - SQUAWWK!"]
        ["You suggest to Polly that there could be an alternative. Something with kids, perhaps?", "Polly: Kids?",
        "Her face lights up with an idea." "Polly: Polly could be a schoolteacher - BRAWWK!",
        "Polly: Kids love pretty birds - SQUAWWK!"]
        ["You tell Polly you'll buy her some supplies to prepare for her job hunt.",
        "Polly: Pretty bird loves pretty-" + gender[0] + " - SQUAWWK!",
        "Buy Polly a few gifts from the shop to continue."]
        ["Polly: You're missing, missing - SQUAWWK!", "Buy Polly more gifts to continue."]
        ["Polly looks through the items.", "Polly: Everything as it should be - BRAWWK - thank you, thank you!",
        ...
        "Polly: So please, let us NOT keep these secrets.", "Polly: You'll thank me later.",
        ...
        "You look at her as if she's discovered a huge secret.", "Polly: SQUAWWK - parrots repeat everything - BRAWWK!",
        "You shake your head and chuckle at her silliness. She laughs too.", "Polly: Parrot good teacher - BRAWWK!",
        "Polly: Willow hired on the spot - SQUAWWK!", "Polly: Gate is the best, makes Polly laugh - BRAWWK!",
    ...
    if romance[0] == 0:
        ...
        for key in keys7:
            ...
            player_input = input("> ")
            if player_input == "y":
                keys8 = polly_texts[10]
                for key in keys8:
                    typewriter(key)
            elif player_input == "n":
                keys8 = polly_texts[11]
                for key in keys8:
                    typewriter(key)
            keys9 = polly_texts[12]
            for key in keys9:
                typewriter(key)
                romance[3] += 1
                typewriter("You've increased your romance score with Polly!")
        ...
        keys10 = polly_texts[13]
        for key in keys10:
            typewriter(key)
            player_input = input("> ")
            if player_input == "y":
                keys11 = polly_texts[14]
                for key in keys11:
                    typewriter(key)
                    town()
            elif player_input == "n":
                keys11 = polly_texts[15]
                for key in keys11:
                    typewriter(key)
                    town()
    elif romance[3] == 3 and 0 < gift_measurement < 30:
        keys12 = polly_texts[16]
        for key in keys12:
            typewriter(key)
            town()
    elif romance[3] == 3 and gift_measurement >= 30:
        keys13 = polly_texts[17]
        for key in keys13:
            typewriter(key)
            romance[3] += 1
            typewriter("You've increased your romance score with Polly!")
        ...
        keys14 = polly_texts[18]
        for key in keys14:
            typewriter(key)
            player_input = input("> ")
            if player_input == "y":
                keys15 = polly_texts[19]
                for key in keys15:
                    typewriter(key)
            elif player_input == "n":
                keys15 = polly_texts[20]
                for key in keys15:
                    typewriter(key)
            keys16 = polly_texts[21]
            for key in keys16:
                typewriter(key)
                town()
    elif romance[3] == 4 and 0 < gift_measurement < 40:
        keys17 = polly_texts[22]
        for key in keys17:
            typewriter(key)
            town()
    elif romance[3] == 4 and gift_measurement >= 40:
        keys18 = polly_texts[23]
        for key in keys18:
            typewriter(key)
            romance[3] += 1
            typewriter("You've increased your romance score with Polly!")
        ...
        if romance[5] < 6:
            keys26 = polly_texts[33]
            for key in keys26:
                typewriter(key)
                town()
        elif romance[5] == 6:
            keys26 = polly_texts[34]
            for key in keys26:
                typewriter(key)
                town()
...
def gate():
    ...
    gate_texts = {"You notice a group of people crowding around a single spot.": {},
            ...
            "Gate: Thank you... friend.": {},"Gate: What's your name again?": {},"You tell Gate your name.": {},
            ...
            f"Gate: Oh, hey there {name_color()}.": {},"Gate: I was just looking at the way you humans cook!": {},
            ...
            "Gate: Can you explain how to add this... soogarr?": {}, "Take the time to explain sugar to Gate (y/n)?":{
            ...
            "Gate: I would be very grateful!": {}, "Buy Gate a gift from the shop to continue.": {}, town(): {},
            ...
            "Gate: Now we're ready to begin.": {}, "Gate takes a lockpick and easily manages to open the door.": {},
            "Gate: OK Mayor-person! Come out wherever you are!": {}, "The Mayor's voice shouts back from inside:": {},
            ...
            "There's an unusual pause of silence. Gate isn't their normal, talkative self.": {}, "Gate: ...": {},
    ...
    if romance[2] < 1:
                    ...
                    for sub_key in gate_texts[key][player_input]:
                        ...
                        for key in keys0:
                            ...
                            if player_input in ['y', 'n']:
                                for sub_key in gate_texts[key][player_input]:
                                    typewriter(sub_key)
                                    keys1 = list(gate_texts.keys())[6:12]
                                    for key in keys1:
                                        typewriter(key)
                                        romance[2] += 1
                                        ...
                                        town()
    elif romance[2] == 1 and gifting * gifts * level == 0:
        keys2 = list(gate_texts.keys())[13:22]
        for key in keys2:
            typewriter(key)
            if key == "Take the time to explain sugar to Gate (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key in gate_texts[key][player_input]:
                        typewriter(sub_key)
                        keys3 = list(gate_texts.keys())[23:25]
                        for key in keys3:
                            typewriter(key)
    elif romance[2] == 1 and gifting * gifts * level >= 10:
        gifts = 0
        keys4 = list(gate_texts.keys())[26:45]
        for key in keys4:
            typewriter(key)
            romance[2] += 1
            typewriter("You've increased your romance score with Gate!")
            typewriter(f"Your new score is {str(romance[2])}")
            town()
    elif romance[2] == 2 and gifting * gifts * level == 0:
        keys5 = list(gate_texts.keys())[46:50]
        for key in keys5:
            typewriter(key)
            if key == "Ask Gate what happened (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key in gate_texts[key][player_input]:
                        typewriter(sub_key)
    elif romance[2] == 2 and 0 < gifting * gifts * level < 20:
        keys6 = list(gate_texts.keys())[51:54]
        for key in keys6:
            typewriter(key)
    elif romance[2] == 2 and gifting * gifts * level >= 20:
        gifts = 0
        keys7 = list(gate_texts.keys())[55:63]
        for key in keys7:
            typewriter(key)
            if key == "Stop the argument (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key in gate_texts[key][player_input]:
                        typewriter(sub_key)
                        keys8 = list(gate_texts.keys())[64:75]
                        for key in keys8:
                            typewriter(key)
                            romance[2] += 1
                            typewriter("You've increased your romance score with Gate!")
                            typewriter(f"Your new score is {str(romance[2])}")
                            town()
    elif romance[2] == 3 and gifting * gifts * level == 0:
        keys8 = list(gate_texts.keys())[76:89]
        for key in keys8:
            typewriter(key)
            if key == "Do you know (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key in gate_texts[key][player_input]:
                        ...
                        for key in keys9:
                            typewriter(key)
    elif romance[2] == 4 and 0 < gifting * gifts * level < 30:
        keys10 = list(gate_texts.keys())[97:99]
        for key in keys10:
            typewriter(key)
    elif romance[2] == 3 and gifting * gifts * level >= 30:
        gifts = 0
        keys11 = list(gate_texts.keys())[100:109]
        for key in keys11:
            typewriter(key)
            romance[2] += 1
            typewriter("You've increased your romance score with Gate!")
            typewriter(f"Your new score is {str(romance[2])}")
            town()
    elif romance[2] == 4 and gifting * gifts * level == 0:
        keys11 = list(gate_texts.keys())[110:113]
        for key in keys11:
            typewriter(key)
            if key == "Leave Gate alone (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key in gate_texts[key][player_input]:
                        typewriter(sub_key)
    elif romance[2] == 4 and 0 < gifting * gifts * level < 40:
        keys12 = list(gate_texts.keys())[114:115]
        for key in keys12:
            typewriter(key)
    elif romance[2] == 4 and gifting * gifts * level >= 40:
        gifts = 0
        keys13 = list(gate_texts.keys())[116:125]
        for key in keys13:
            typewriter(key)
            romance[2] += 1
            typewriter("You've increased your romance score with Gate!")
            typewriter(f"Your new score is {str(romance[2])}")
    elif romance[2] == 5 and gifting * gifts * level == 0:
        keys14 = list(gate_texts.keys())[126:128]
        for key in keys14:
            typewriter(key)
            if key == "Investigate (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key in gate_texts[key][player_input]:
                        typewriter(sub_key)
                        keys15 = list(gate_texts.keys())[129:138]
                        for key in keys15:
                            typewriter(key)
                            if key == "Fight the guards (y/n)?":
                                ...
                                if player_input in ['y', 'n']:
                                    for sub_key in gate_texts[key][player_input]:
                                        typewriter(sub_key)
                                        keys15 = list(gate_texts.keys())[139:141]
                                        for key in keys15:
                                            typewriter(key)
                                            ...
                                            keys16 = list(gate_texts.keys())[142:149]
                                            for key in keys16:
                                                typewriter(key)
                                                romance[2] += 1
                                                typewriter("You've increased your romance score with Gate!")
        ...
        keys17 = list(gate_texts.keys())[150:151]
        for key in keys17:
            typewriter(key)
        if romance[5] < 6:
            keys18 = list(gate_texts.keys())[152:157]
            for key in keys18:
                typewriter(key)
        elif romance[5] == 6:
            keys18 = list(gate_texts.keys())[158:168]
            for key in keys18:
                typewriter(key)


def sam():
    global level, gifting, gifts
    gate_texts = {"The highly masculine Orc is standing alone. She greets you in her usual gruff voice.": {},
                "Sam: Heya, " + name_color() + "!": {},
    ...
    if romance[1] == 0:
            ...
            if key == "Tell Sam your name (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key in sam_texts[key][player_input]:
                        ...
                        player_input = input("> ").lower()
                        if player_input in ['y', 'n']:
                            for sub_key1 in sam_texts[key][player_input]:
                                typewriter(sub_key1)
                        else:
    ...
    elif romance[1] == 1 and gifting * gifts * level == 0:
        keys1 = list(sam_texts.keys())[6:8]
        for key in keys1:
            typewriter(key)

    elif romance[1] == 1 and gifting * gifts * level >= 10:
        keys2 = list(sam_texts.keys())[9:12]
        for key in keys2:
            typewriter(key)
            if key == "Agree with Sam? (y/n)?":
                player_input = input("> ").lower()
                if player_input in ['y', 'n']:
                    for sub_key2 in gate_texts[key][player_input]:
                        typewriter(sub_key2)
        keys3 = list(sam_texts.keys())[13:21]
        for key in keys3:
            typewriter(key)
    elif romance[1] == 2 and gifting * gifts * level == 0:
        keys4 = list(sam_texts.keys())[22:26]
        for key in keys4:
            typewriter(key)
            if key == "Allow Sam to keep the sword (y/n)?":
                player_input = input("> ").lower()
                if player_input in ['y', 'n']:
                    for sub_key3 in sam_texts[key][player_input]:
                        typewriter(sub_key3)
        keys5 = list(sam_texts.keys())[27:33]
        for key in keys5:
            typewriter(key)
    elif romance[1] == 2 and gifting * gifts * level < 20:
        keys6 = list(sam_texts.keys())[34:36]
        for key in keys6:
            typewriter(key)
    elif romance[1] == 2 and gifting * gifts * level >= 20:
        gifts = 0
        keys7 = list(sam_texts.keys())[37:42]
        for key in keys7:
            typewriter(key)
            if key == "Ask what Sam means (y/n)?":
                player_input = input("> ").lower()
                if player_input in ['y', 'n']:
                    for sub_key4 in sam_texts[key][player_input]:
                        typewriter(sub_key4)
        if romance[0] == 2:
            keys8 = list(sam_texts.keys())[43:48]
            for key in keys8:
                typewriter(key)
        keys9 = list(sam_texts.keys())[49:52]
        for key in keys9:
            typewriter(key)
        romance[1] += 1
        typewriter("You've increased your romance score with Sam!")
        ...
        keys10 = list(sam_texts.keys())[53:55]
        for key in keys10:
            typewriter(key)
            if key == "Did you hear (y/n)?":
                player_input = input("> ").lower()
                if player_input in ['y', 'n']:
                    for sub_key5 in sam_texts[key][player_input]:
                        typewriter(sub_key5)
        keys11 = list(sam_texts.keys())[56:60]
        for key in keys11:
            typewriter(key)
    elif romance[1] == 3 and 0 < gifting * gifts * level < 30:
        keys12 = list(sam_texts.keys())[61:64]
        for key in keys12:
            typewriter(key)
        town()
    elif romance[1] == 3 and gifting * gifts * level >= 30:
        gifts = 0
        keys13 = list(sam_texts.keys())[65:68]
        for key in keys13:
            typewriter(key)
        romance[1] += 1
        "You've increased your romance score with Sam!"
        "Your new score is " + str(romance[1])
    elif romance[1] == 4 and gifting * gifts * level == 0:
        keys14 = list(sam_texts.keys())[68:73]
        for key in keys14:
            typewriter(key)
    elif romance[1] == 4 and 0 < gifting * gifts * level < 40:
        keys15 = list(sam_texts.keys())[74:76]
        for key in keys15:
            typewriter(key)
    elif romance[1] == 4 and gifting * gifts * level >= 40:
        gifts = 0
        keys16 = list(sam_texts.keys())[77:81]
        for key in keys16:
            typewriter(key)
        romance[1] += 1
        "You've increased your romance score with Sam!"
        "Your new score is " + str(romance[1])
        town()
    elif romance[1] == 5 and gifting * gifts * level == 0:
        keys17 = list(sam_texts.keys())[82:83]
        for key in keys17:
            typewriter(key)
            if key == "Do a favor for Sam (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key5 in sam_texts[key][player_input]:
                        typewriter(sub_key5)
        keys18 = list(sam_texts.keys())[84:89]
        for key in keys18:
            typewriter(key)
    elif romance[1] == 5 and 0 < gifting * gifts * level < 50:
        keys19 = list(sam_texts.keys())[90:94]
        for key in keys19:
            typewriter(key)
    elif romance[1] == 5 and gifting * gifts * level >= 50:
        gifts = 0
        keys20 = list(sam_texts.keys())[95:112]
        for key in keys20:
            typewriter(key)
        romance[1] += 1
        "You've increased your romance score with Sam!"
        ...
        keys21 = list(sam_texts.keys())[113:117]
        for key in keys21:
            typewriter(key)
    elif romance[5] == 6:
        keys22 = list(sam_texts.keys())[118:125]
        for key in keys22:
            typewriter(key)
        town()
...
def willow():
    ...
    willow_texts = {"You come across five Goblins standing in the town centre.": {},
        ...
        "Give Willow your name (y/n?)":{
            'n': {"Willow: ...Oh, I guess you're busy.", "Willow walks away with her friends, looking dejected.",
            town()},
            'y': {"Willow perks up.", "Willow: Oh, that's such a lovely name! I could say it all day!"
            "Willow: " + name_color() + ", " + name_color() + ", " + name_color() + "! ",
            "Willow: That's so fun!", "Willow: I like you, " + name_color() + ", let's grab lunch sometime!"}},
        "Willow: Did you bring lunch?": {}, "Willow: Oh, but I'm hungry!": {},
        "Willow: Please can you buy some lunch for me?": {}, "Buy Willow a gift in the shop to continue.": {},
        ...
        town(): {}, "Willow: Hey there, " + name_color() + "!": {}, "Willow: I enjoyed our lunch date so, so much!": {},
        ...
        "You explain to Willow you've met Sam.": {},"Willow: You did!? How is he? Is he living in the town, too?": {},
        "You explain to Willow that Sam is safe and is living as herself now.": {}, "Willow: ..HERself?": {},
        "Willow: I KNEW IT!": {},
        ...
        "Willow: Well if it isn't the wonderful " + gender[0] + " that I've been telling EVERYONE about!": {},
        ...
        "Willow: Please get some more gifts!": {}, town(): {},"Willow: You got the stuff! Thank you!": {},
            ...
            if key == "Give Willow your name (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key in willow_texts[key][player_input]:
                        ...
                        town()
    if romance[0] == 1 and gifting * gifts * level == 0:
        keys0 = list(willow_texts.keys())[8:11]
        for key in keys0:
            typewriter(key)
    while romance[0] == 1 and gifting * gifts * level >= 10:
        gifts = 0
        keys1 = list(willow_texts.keys())[12:17]
        for key in keys1:
            typewriter(key)
            if key == "Respond: (y/n)?":
                player_input = input("> ").lower()
                if player_input in ['y', 'n']:
                    for sub_key5 in sam_texts[key][player_input]:
                        typewriter(sub_key5)
                        keys2 = list(willow_texts.keys())[18:22]
                        for key in keys2:
                            typewriter(key)
                            romance[0] += 1
                            ...
                            town()
    if romance[0] == 2 and gifting * gifts * level == 0:
        keys3 = list(willow_texts.keys())[23:28]
        for key in keys3:
            typewriter(key)
    if romance[0] == 2 and 0 < gifting * gifts * level < 20:
        typewriter("Willow: That's only one shoe! I have two feet, silly!")
        town()
    while romance[0] == 2 and gifting * gifts * level >= 20:
        gifts = 0
        keys4 = list(willow_texts.keys())[29:42]
        for key in keys4:
            typewriter(key)
            if romance[1] >= 3:
            ...
            "Your new score is " + str(romance[0])
            town()
    if romance[0] == 3 and gifts * gifting * level == 0:
        keys5 = list(willow_texts.keys())[43:50]
        for key in keys5:
            typewriter(key)
    elif romance[0] == 3 and 0 < gifting * gifts * level < 30:
        typewriter("Willow: Nooo! I need more parchments for my MASTERPIECE!")
        town()
    while romance[0] == 3 and gifts * gifting * level >= 30:
        gifts = 0
        keys6 = list(willow_texts.keys())[51:56]
        for key in keys6:
            typewriter(key)
            if key == "Forgive Willow for deceiving you (y/n)?":
                ...
                if player_input in ['y', 'n']:
                    for sub_key5 in sam_texts[key][player_input]:
                        ...
                        "Your new score is " + str(romance[0])
                        town()
    if romance[0] == 4 and gifting * gifts * level == 0:
        keys7 = list(willow_texts.keys())[57:43]
        for key in keys7:
            typewriter(key)
    elif romance[0] == 4 and 0 < gifting * gifts * level < 40:
        keys8 = list(willow_texts.keys())[44:47]
        for key in keys8:
            typewriter(key)
    while romance[0] == 4 and gifting * gifts * level >= 40:
        gifts = 0
        keys9 = list(willow_texts.keys())[48:54]
        for key in keys9:
            typewriter(key)
        romance[0] += 1
        "You've increased your romance score with Willow!"
    ...
    if romance[0] == 5:
        ...
        if romance[2] == 6:
            typewriter("Willow: Gate's cooking recipes are also a HUGE hit with the kids!")
    ...
    while romance[0] == 6:
        ...
        if romance[5] < 6:
            ...
            town()
        if romance[5] == 6:
            keys10 = list(willow_texts.keys())[55:61]
            for key in keys10:
                typewriter(key)
...
def enemy_convo():
    global enemy, quest_goblins, quest_slimes, quest_orcs, quest_harpies, quest_minotaurs, completed_quest,\
        keyenchant, keymold, keymaterial, endgame
    clear()
    draw()
    if enemy == "Goblin":
        ...
        if choice_goblin == "yes":
            ...
            enemy_convo()
    elif enemy == "Orc" and quest_orcs == 0:
        ...
        quest_orcs += 1
        play()
    elif enemy == "Orc" and quest_orcs == 1:
        ...
        play()
    elif enemy == "Slime" and quest_slimes == 0:
        ...
        if choice_slime == "who":
            ...
            typewriter("That's not a valid option!")
            enemy_convo()
    elif enemy == "Harpy" and quest_harpies == 0:
        ...
        play()
    elif enemy == "Harpy" and quest_harpies == 1:
...
def battle():
    global level, name, HP, HPMAX, MP, MPMAX, job, ATK, ability, pot, elix, boss, gold, \
        completed_quest, endgame, fight, achievements_killer, quest_minotaurs, quest_goblins, \
        quest_slimes, quest_orcs, quest_harpies, quest_enemy, hpmax, hp, at, enemy, pacifist, speech, \
        pacifist_ruined
    totem = 0
    Round = 0
    ...
    if not boss:
        if quest_enemy == 0:
            enemy = "Goblin"
        elif quest_enemy == 1 and quest_goblins < 4:
            enemy = "Goblin"
    ...
    while fight:
        ...
        while not pacifist:
            ...
            if choice_battle == "1":
            ...
            elif quest_enemy == 0 and choice_battle == "6":
                ...
                completed_quest = True
                pacifist = True
            elif quest_enemy > 0 and not pacifist_ruined and choice_battle == "6":
            ...
            elif quest_enemy > 0 and pacifist_ruined and choice_battle == "6":
                ...
                if endgame:
                    if enemy == "Goblin":
                        ...
                        if achievements_killer['Slayer'][0]['Required'] >= achievements_killer['Slayer'][0]['Goal']:
                            if job != "Shaman":
                                ATK *= achievements_killer['Slayer'][0]['ATK Increase']
                                ...
                                TATK *= achievements_killer['Slayer'][0]['ATK Increase']
                                achievements_killer['Slayer'][0]['Required'] = achievements_killer['Slayer'][0]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                        ...
                        if achievements_killer['Slayer'][1]['Required'] >= achievements_killer['Slayer'][1]['Goal']:
                            if job != "Shaman":
                                ATK *= achievements_killer['Slayer'][1]['ATK2 Increase']
                                achievements_killer['Slayer'][1]['Required'] = achievements_killer['Slayer'][1]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                            else:
                                TATK *= achievements_killer['Slayer'][1]['ATK2 Increase']
                                achievements_killer['Slayer'][1]['Required'] = achievements_killer['Slayer'][1]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                        ...
                        if achievements_killer['Slayer'][2]['Required'] >= achievements_killer['Slayer'][2]['Goal']:
                            if job != "Shaman":
                                ATK *= achievements_killer['Slayer'][2]['ATK3 Increase']
                                achievements_killer['Slayer'][2]['Required'] = achievements_killer['Slayer'][2]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                            else:
                                TATK *= achievements_killer['Slayer'][2]['ATK3 Increase']
                                achievements_killer['Slayer'][2]['Required'] = achievements_killer['Slayer'][2]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                        ...
                        if achievements_killer['Slayer'][3]['Required'] >= achievements_killer['Slayer'][3]['Goal']:
                            if job != "Shaman":
                                ATK *= achievements_killer['Slayer'][3]['ATK4 Increase']
                                achievements_killer['Slayer'][3]['Required'] = achievements_killer['Slayer'][3]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                            else:
                                TATK *= achievements_killer['Slayer'][3]['ATK4 Increase']
                                achievements_killer['Slayer'][3]['Required'] = achievements_killer['Slayer'][3]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                        ...
                        if achievements_killer['Slayer'][4]['Required'] >= achievements_killer['Slayer'][4]['Goal']:
                            if job != "Shaman":
                                ATK *= achievements_killer['Slayer'][4]['ATK5 Increase']
                                achievements_killer['Slayer'][4]['Required'] = achievements_killer['Slayer'][4]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                            else:
                                TATK *= achievements_killer['Slayer'][4]['ATK5 Increase']
                                achievements_killer['Slayer'][4]['Required'] = achievements_killer['Slayer'][4]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                        ...
                        if achievements_killer['Slayer'][5]['Required'] >= achievements_killer['Slayer'][5]['Goal']:
                            if job != "Shaman":
                                ATK *= achievements_killer['Slayer'][5]['ATK6 Increase']
                                achievements_killer['Slayer'][5]['Required'] = achievements_killer['Slayer'][5]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
                            else:
                                TATK *= achievements_killer['Slayer'][5]['ATK6 Increase']
                                achievements_killer['Slayer'][5]['Required'] = achievements_killer['Slayer'][5]['Goal']
                                achievements_killer['Meta'][1]['Required'] += 1
                                if achievements_killer['Meta'][1]['Required'] >= achievements_killer['Meta'][1]['Goal']:
                                    achievements_killer['Meta'][1]['Required'] = achievements_killer['Meta'][1]['Goal']
...
def shop(buy):
    global gold, pot, elix, job, TATK, level, ATK, HPMAX, MPMAX, keymaterial, completed_quest, quest_gifts, \
        quest_minotaurs2, gifts
    while buy:
        while not pacifist:
            clear()
            draw()
                ...
                if gold >= 5:
                    ...
                    if endgame:
                        ...
                        if achievements_killer['Shopping'][1]['Required'] >= achievements_killer['Shopping'][1]['Goal']:
                            MPMAX *= achievements_killer['Shopping'][1]['MAXMP2 Increase']
                ...
                if gold >= 5:
                    ...
                    if endgame:
                        ...
                        if achievements_killer['Shopping'][0]['Required'] >= achievements_killer['Shopping'][0]['Goal']:
                            MPMAX *= achievements_killer['Shopping'][0]['MAXMP1 Increase']
                    ...
                    if job == "Shaman":
                        ...
                        if endgame:
                            ...
                            if achievements_killer['Shopping'][2]['Required'] >= \
                                ...
                                MPMAX *= achievements_killer['Shopping'][2]['MAXMP1 Increase']
                ...
                if gold >= 10:
                    ...
                    if endgame:
                        ...
                        if achievements_killer['Shopping'][3]['Required'] >= achievements_killer['Shopping'][3]['Goal']:
                            MPMAX *= achievements_killer['Shopping'][3]['MAXMP1 Increase']
                ...
                if gold >= 10:
                    ...
                    if endgame:
                        ...
                        if achievements_killer['Shopping'][4]['Required'] >= achievements_killer['Shopping'][4]['Goal']:
                            MPMAX *= achievements_killer['Shopping'][4]['MAXMP1 Increase']
        ...
        while pacifist:
            ...
            draw()
            typewriter(f"1 - BUY POTION ({20 * level}HP) - 5 GOLD")
            typewriter("2 - UPGRADE HAT (+" + str(2 * level) + " SPEECH) - 10 GOLD")
            typewriter(f"3 - UPGRADE BOOTS (+{2 * level} WORK ETHIC) - 10 GOLD")
            typewriter(f"4 - UPGRADE GLOVES (+{2 * level} GIFT GIVING) - 10 GOLD")
            draw()
            if quest_gifts == 0 and quest_minotaurs2 == 1:
            ...
            if choice_shop1 == "1":
                ...
                if gold >= 10:
                    ...
                    typewriter("Not enough gold!")
                    shop(buy)
            elif choice_shop1 == "5" and quest_gifts == 0 and quest_minotaurs2 == 1:
                if gold >= 100:
                    quest_gifts += 1
...
def mayor():
    global map, biom, y_len, x_len, name, quest_minotaurs, quest_goblins, quest_slimes, quest_harpies, \
        quest_orcs, quest_enemy, keymaterial, keymold, keyenchant, pot, elix, completed_quest, pacifist, \
        quest_minotaurs2, quest_gifts, quest_town, pacifist_ruined
    clear()
    draw()
    ...
    elif quest_goblins < 4 and not pacifist:
        for text in quest_texts1[0][1]:
            typewriter(text)
    elif quest_goblins < 4 and pacifist:
        for text in quest_texts1[0][1]:
            typewriter(text)
    elif quest_orcs < 2 and not pacifist:
        for text in quest_texts1[0][2]:
            typewriter(text)
    elif quest_orcs < 2 and pacifist:
        for text in quest_texts2[0][1]:
            typewriter(text)
    elif quest_slimes < 4 and not pacifist:
        for text in quest_texts1[0][3]:
            typewriter(text)
    elif quest_slimes < 4 and pacifist:
        for text in quest_texts2[0][2]:
            typewriter(text)
    elif quest_harpies < 2 and not pacifist:
        for text in quest_texts1[0][4]:
            typewriter(text)
    elif quest_harpies < 2 and pacifist:
        for text in quest_texts2[0][3]:
            typewriter(text)
    elif quest_harpies == 2 and keymold == 0 and not pacifist:
        for text in quest_texts1[0][5]:
            typewriter(text)
    elif quest_harpies == 2 and pacifist:
        for text in quest_texts2[0][4]:
            typewriter(text)
    elif quest_minotaurs2 == 1 and pacifist:
        for text in quest_texts2[0][5]:
            typewriter(text)
    elif quest_town == 1 and pacifist:
        for text in quest_texts2[0][6]:
            typewriter(text)
    elif quest_gifts == 1 and pacifist:
        for text in quest_texts2[0][7]:
            typewriter(text)
    elif keymold == 1 and keymaterial == 0 and not pacifist:
        for text in quest_texts1[0][6]:
            typewriter(text)
    elif keymold == 1 and keymaterial == 1 and keyenchant == 0 and not pacifist:
        if elix < 10:
            ...
            completed_quest = True
            keyenchant += 1
    elif keyenchant == 1 and not pacifist:
...
def town():
    global quest_town, quest_minotaurs2, pacifist_ruined, pacifist, romance
    clear()
    draw()
    if quest_minotaurs2 == 1 and quest_town == 0:
    ...
    if quest_town == 1 and quest_gifts == 1:
        typewriter("Visit your friend Jake (y/n)?")
        giftquest1 = input("> ")
        if giftquest1 == "n":
            play()
...
def new_game():
    global name, job, ability, HPMAX, MPMAX, ATK, HP, MP, TATK, speech, work, gifting
    clear()
    with open("blacklist.txt", "r") as f:
        ...
        if name not in blacklist:
            ...
            for i, (job, ability, HP, MP, ATK, TATK, speech, work, gifting) in enumerate(job_options):
            ...
            job, ability, HPMAX, MPMAX, ATK, TATK, speech, work, gifting = job_options[job_choice]
            HP = HPMAX
            MP = MPMAX
    ...
    if endgame:
        ...
        if map[y][x] == "plains":
            ...
            if achievements_killer['Exploration'][0]['Required'] >= achievements_killer['Exploration'][0]['Goal']:
                HPMAX *= achievements_killer['Exploration'][0]['MAXHP1 Increase']
            ...
            if achievements_killer['Exploration'][1]['Required'] >= achievements_killer['Exploration'][1]['Goal']:
                HPMAX *= achievements_killer['Exploration'][1]['MAXHP2 Increase']
            ...
            if achievements_killer['Exploration'][2]['Required'] >= achievements_killer['Exploration'][2]['Goal']:
                HPMAX *= achievements_killer['Exploration'][2]['MAXHP3 Increase']
            ...
            if achievements_killer['Exploration'][3]['Required'] >= achievements_killer['Exploration'][3]['Goal']:
                HPMAX *= achievements_killer['Exploration'][3]['MAXHP4 Increase']
            ...
            if achievements_killer['Exploration'][4]['Required'] >= achievements_killer['Exploration'][4]['Goal']:
                HPMAX *= achievements_killer['Exploration'][4]['MAXHP5 Increase']
            ...
            if achievements_killer['Exploration'][5]['Required'] >= achievements_killer['Exploration'][5]['Goal']:
                HPMAX *= achievements_killer['Exploration'][5]['MAXHP6 Increase']
